...
import 'package:pizzer_mobile/pages/profile_worker_info_page.dart';
import 'package:pizzer_mobile/pages/worker_orders_page.dart';

class ProfileWorkerPage extends StatelessWidget {
  String? token;
  ProfileWorkerPage({super.key, this.token});
      ...
      child: BlocBuilder<ProfileBloc, ProfileState>(
        builder: (context, state) {
          ...
          if (state is ProfileInfoChosenState) {
            return workerProfileInfoLoaded(context, state);
          }
  ...
  Widget workerProfileInfoLoaded(context, state) {
